...
namespace Mimarlik.Infrastructure.Migrations
{
    ...
    [Migration("20250915133404_InitialCreate")]
            ...
            modelBuilder.Entity("Mimarlik.Core.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 9, 15, 13, 34, 4, 235, DateTimeKind.Utc).AddTicks(8454),
                            Description = "Genel mimari projeler",
                            Slug = "mimari-projeler",
                            SortOrder = 1,
                            Status = 1,
                            Title = "Mimari Projeler",
                            UpdatedAt = new DateTime(2025, 9, 15, 13, 34, 4, 235, DateTimeKind.Utc).AddTicks(8454)
                        });
                });
            ...
            modelBuilder.Entity("Mimarlik.Core.Entities.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "tr",
                            CreatedAt = new DateTime(2025, 9, 15, 13, 34, 4, 235, DateTimeKind.Utc).AddTicks(8302),
                            IsDefault = true,
                            Name = "Türkçe",
                            NativeName = "Türkçe",
                            SortOrder = 1,
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 9, 15, 13, 34, 4, 235, DateTimeKind.Utc).AddTicks(8305)
                        },
                        new
                        {
                            Id = 2,
                            Code = "en",
                            CreatedAt = new DateTime(2025, 9, 15, 13, 34, 4, 235, DateTimeKind.Utc).AddTicks(8308),
                            IsDefault = false,
                            Name = "English",
                            NativeName = "English",
                            SortOrder = 2,
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 9, 15, 13, 34, 4, 235, DateTimeKind.Utc).AddTicks(8309)
                        });
                });
