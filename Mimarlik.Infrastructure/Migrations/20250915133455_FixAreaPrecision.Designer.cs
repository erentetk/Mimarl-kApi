...
namespace Mimarlik.Infrastructure.Migrations
{
    ...
    [Migration("20250915133455_FixAreaPrecision")]
    partial class FixAreaPrecision
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mimarlik.Core.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 9, 15, 13, 34, 54, 456, DateTimeKind.Utc).AddTicks(8107),
                            Description = "Genel mimari projeler",
                            Slug = "mimari-projeler",
                            SortOrder = 1,
                            Status = 1,
                            Title = "Mimari Projeler",
                            UpdatedAt = new DateTime(2025, 9, 15, 13, 34, 54, 456, DateTimeKind.Utc).AddTicks(8108)
                        });
                });
            ...
            modelBuilder.Entity("Mimarlik.Core.Entities.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "tr",
                            CreatedAt = new DateTime(2025, 9, 15, 13, 34, 54, 456, DateTimeKind.Utc).AddTicks(7815),
                            IsDefault = true,
                            Name = "Türkçe",
                            NativeName = "Türkçe",
                            SortOrder = 1,
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 9, 15, 13, 34, 54, 456, DateTimeKind.Utc).AddTicks(7822)
                        },
                        new
                        {
                            Id = 2,
                            Code = "en",
                            CreatedAt = new DateTime(2025, 9, 15, 13, 34, 54, 456, DateTimeKind.Utc).AddTicks(7828),
                            IsDefault = false,
                            Name = "English",
                            NativeName = "English",
                            SortOrder = 2,
                            Status = 1,
                            UpdatedAt = new DateTime(2025, 9, 15, 13, 34, 54, 456, DateTimeKind.Utc).AddTicks(7828)
                        });
                });
